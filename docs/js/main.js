...
function img01 () {
    document.querySelector("[data-img01]").src="./img/Robotron 2000 - Branco.png";
    document.querySelector("[data-img01]").src="./img/Robotron 2000 - Vermelho.png";
    document.querySelector("[data-img01]").src="./img/Robotron 2000 - Amarelo.png";
    document.querySelector("[data-img01]").src="./img/Robotron 2000 - Rosa.png";
}